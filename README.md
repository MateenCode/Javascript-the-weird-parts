...
The code that you write gets placed in the special property of the function object. So it isn't like the code you write _is_ a function. The function _is_ an object with other properties. And the code that you write is just one of those properties that you're adding onto it. What is special about that property that it's invocable. You can say run that code and that's when execution context creation and execution happens.
...
// this little trick returns a string '[object Array]'
```
...
console.log(e instanceof Person); // returns true because
//Person is down the prototype chain of e
